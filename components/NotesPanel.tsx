    ...
    return (
      <div className="flex flex-col h-full gap-5 py-4">
            ...
            {DEPTH_OPTIONS.map((opt) => (
              <button
                ...
                className={`p-3 rounded-xl border text-left transition-[border-color,background-color,box-shadow] duration-150 active:scale-[0.97] ${
                  depth === opt.id
                    ? "bg-[#c471ed]/10 border-[#c471ed]/50 shadow-[0_0_12px_rgba(196,113,237,0.1)]"
                    : "bg-[#0d1526] border-[rgba(196,113,237,0.1)] hover:border-[rgba(196,113,237,0.3)]"
                }`}
              >
                <div className="text-xl mb-1">{opt.icon}</div>
                <p className={`text-xs font-bold ${depth === opt.id ? "text-[#c471ed]" : "text-[#f0f4ff]"}`}>{opt.label}</p>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#c471ed] text-[#fff] rounded-xl font-bold text-sm shadow-[0_0_24px_rgba(196,113,237,0.3)] hover:bg-[#d08cf0] hover:shadow-[0_0_32px_rgba(196,113,237,0.4)] transition-[background-color,box-shadow] duration-150 active:scale-[0.97]"
        >
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-6">
        ...
        <div className="text-center">
          <p className="text-[#c471ed] font-semibold">
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 pb-3 shrink-0 flex-wrap">
        ...
        <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-xs font-semibold ${
          depth === "deep"
            ...
            : "bg-[#c471ed]/10 border-[#c471ed]/30 text-[#c471ed]"
        }`}>
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 bg-[#1a2340] border border-[rgba(196,113,237,0.15)] text-[#8892a4] rounded-lg text-xs hover:text-[#f0f4ff] hover:border-[#c471ed]/30 transition-[color,border-color,background-color] duration-150 active:scale-[0.97]"
          >
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs border transition-[color,border-color,background-color] duration-150 active:scale-[0.97] ${
              copied
                ...
                : "bg-[#1a2340] border-[rgba(196,113,237,0.15)] text-[#8892a4] hover:text-[#f0f4ff] hover:border-[#c471ed]/30"
            }`}
          >
            {copied ? (
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 px-2.5 py-1.5 bg-[#c471ed] text-[#fff] rounded-lg text-xs font-bold hover:bg-[#d08cf0] transition-[background-color] duration-150 shadow-[0_0_12px_rgba(196,113,237,0.2)] active:scale-[0.97]">
              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
              Save ▾
            </button>
            <div className="absolute right-0 top-8 z-20 hidden group-hover:flex flex-col bg-[#111827] border border-[rgba(196,113,237,0.2)] rounded-xl shadow-xl overflow-hidden min-w-[120px]"
              style={{ animation: "modalIn 150ms cubic-bezier(0.23,1,0.32,1) both" }}
            >
              <button onClick={() => downloadNotes("md")} className="px-4 py-2.5 text-xs text-[#f0f4ff] hover:bg-[#c471ed]/10 text-left transition-[background-color] duration-150">.md file</button>
              <button onClick={() => downloadNotes("txt")} className="px-4 py-2.5 text-xs text-[#f0f4ff] hover:bg-[#c471ed]/10 text-left transition-[background-color] duration-150">.txt file</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin pr-1">
        <div className="prose prose-invert max-w-none text-sm
          ...
          prose-h1:text-lg prose-h1:font-black prose-h1:text-[#f0f4ff] prose-h1:mb-4 prose-h1:pb-2 prose-h1:border-b prose-h1:border-[rgba(196,113,237,0.15)]

          prose-h2:text-sm prose-h2:font-bold prose-h2:text-[#c471ed] prose-h2:uppercase prose-h2:tracking-widest prose-h2:mt-6 prose-h2:mb-3 prose-h2:pb-1.5 prose-h2:border-b prose-h2:border-[rgba(196,113,237,0.1)]
          ...
          prose-strong:text-[#c471ed] prose-strong:font-bold
          ...
          prose-blockquote:border-l-4 prose-blockquote:border-[#c471ed]/50 prose-blockquote:bg-[#c471ed]/5 prose-blockquote:rounded-r-xl prose-blockquote:px-4 prose-blockquote:py-2 prose-blockquote:my-3 prose-blockquote:not-italic
          prose-blockquote:text-[#c471ed]

          prose-table:border-collapse prose-table:w-full prose-table:text-xs
          prose-thead:bg-[#0d1526]
          prose-th:text-[#c471ed] prose-th:font-semibold prose-th:px-3 prose-th:py-2 prose-th:border prose-th:border-[rgba(196,113,237,0.15)] prose-th:text-left
          prose-td:text-[#d0d8f0] prose-td:px-3 prose-td:py-2 prose-td:border prose-td:border-[rgba(196,113,237,0.08)] prose-td:align-top
          prose-tr:even:bg-[#0d1526]/50

          prose-hr:border-[rgba(196,113,237,0.12)] prose-hr:my-6
